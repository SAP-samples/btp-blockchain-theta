...
replace (
	...
	github.com/thetatoken/theta/common v0.0.0 => github.com/andrewlunde/thetaoffchaingo_common v0.2.0
	github.com/thetatoken/theta/query v0.2.0 => github.com/andrewlunde/thetaoffchaingo_query v0.2.0
	//github.com/thetatoken/theta/query v0.2.0 => ../thetaoffchaingo_query
	github.com/thetatoken/theta/rpc/lib/rpc-codec/jsonrpc2 v0.0.0 => github.com/andrewlunde/thetaoffchaingo_rpc v0.2.0
	github.com/thetatoken/theta/tx v0.2.0 => github.com/andrewlunde/thetaoffchaingo_tx v0.2.0
	//github.com/thetatoken/theta/tx v0.2.0 => ../thetaoffchaingo_tx
	github.com/thetatoken/theta/utils v0.0.0 => github.com/andrewlunde/thetaoffchaingo_utils v0.2.0
)
