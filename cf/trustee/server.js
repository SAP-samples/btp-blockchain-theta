...
app.get("/trustee/deploy-contract-ln", async function (req, res) {
	...
	try {
		ABIToDeploy = fs.readFileSync('../../sol/outbin/abi.json','utf8');
		objectToDeploy = fs.readFileSync('../../sol/outbin/object.json','utf8');
		opcodesToDeploy = fs.readFileSync('../../sol/outbin/opcodes.json','utf8');
		sourceMapToDeploy = fs.readFileSync('../../sol/outbin/sourceMap.json','utf8');
		byteCodeToDeploy = {
			"linkReferences": {},
