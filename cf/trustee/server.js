...
app.get("/trustee/deploy-contract-ln", async function (req, res) {
    ...
    const ABIToDeploy = fs.readFileSync('../../sol/outbin/abi.json','utf8');
    const objectToDeploy = fs.readFileSync('../../sol/outbin/object.json','utf8');
    const opcodesToDeploy = fs.readFileSync('../../sol/outbin/opcodes.json','utf8');
    const sourceMapToDeploy = fs.readFileSync('../../sol/outbin/sourceMap.json','utf8');
    const byteCodeToDeploy = {
        "linkReferences": {},
        "object": objectToDeploy,
        "opcodes": objectToDeploy,
